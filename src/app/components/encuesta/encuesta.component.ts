...
export class EncuestaComponent implements OnInit {
  ...
  descriptions: any = [
    ...
    { id: 3, description:"Hoy en día no tiene mucho sentido comprar un portátil que no tenga SSD, por lo que la recomendación es que si el portátil tiene un disco duro convencional, no te plantees su compra porque vas a notar que va lento desde el primer día. Incluso aquellos portátiles con SSD SATA 3 van a proporcionarte un rendimiento y unos tiempos de encendido muchísimo mejores, así que la recomendación aquí es que busques siempre opciones que tengan SSD." , price: 4000 },
    { id: 4, description:"Dependiendo de para qué vayas a utilizar el portátil, la gráfica dedicada puede ser importante o no. Obviamente si quieres usar el portátil para jugar necesitarás buscar una gráfica dedicada AMD o NVIDIA en tu portátil, lo cual aumentará considerablemente su precio. Pero si no es tu caso, con la gráfica integrada que venga en el procesador tendrás suficiente para casi todo, incluso para juegos sencillos si pretendes jugar de manera esporádica." , price: 4000 }
  ];
  array1:any = [];
  array2:any = [];
  getDescription(){
